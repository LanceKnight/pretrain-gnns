...
def print_model_size(model):
    '''
    calculate the estimated memory usage by the model
    '''

    element_size_list = [param.element_size() for param in model.parameters()]
    mean_element_size = sum(element_size_list) / len(element_size_list)
