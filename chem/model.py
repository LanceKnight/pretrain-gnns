...
class GNN_graphpred(torch.nn.Module):
    ...
    def forward(self, *argv):
        ...
        return self.graph_pred_linear(graph_rep), graph_rep
...
if __name__ == "__main__":
    ...
    model = GNN_graphpred(num_layer=5, emb_dim=2, num_tasks=1, JK="last", drop_ratio=0, graph_pooling="mean", gnn_type="gin")
